namespace eRenting.Migrations
{
    ...
    public partial class AddEmpresasCollection1 : DbMigration
    {
        public override void Up()
        {
            ...
            AlterColumn("dbo.Funcionarios", "Empresa_Empresa_id", c => c.Int());
        ...
        public override void Down()
        {
            ...
            AlterColumn("dbo.Funcionarios", "Empresa_Empresa_id", c => c.Int(nullable: false));
