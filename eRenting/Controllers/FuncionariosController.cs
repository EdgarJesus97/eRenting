...
namespace eRenting.Controllers
{
    public class FuncionariosController : Controller
    {
        ...
        {
            var funcionarios = db.Funcionario.Include(c => c.Empresa);
        ...
        public ActionResult Details(int? id)
        {
            ...
            Funcionario funcionario = db.Funcionario.Include( c => c.Empresa)
                                                    .FirstOrDefault(x => x.Funcionario_id == id);
            if (funcionario == null)
            {
                return HttpNotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Funcionario_id,Nome,Contacto,Email")] Funcionario funcionario)
        {
            if (ModelState.IsValid)
            {
